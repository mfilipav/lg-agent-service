...
async def main() -> None:
    ...
    with st.sidebar:
        ...
        #     st.image(
        #         "https://https://github.com/mfilipav/lg-agent-service/blob/main/media/agent_architecture.png?raw=true"
        #     )
        #     "[View full size on Github](https://https://github.com/mfilipav/lg-agent-service/blob/main/media/agent_architecture.png)"
        #     st.caption(
        ...
        "[View the source code](https://https://github.com/mfilipav/lg-agent-service)"
